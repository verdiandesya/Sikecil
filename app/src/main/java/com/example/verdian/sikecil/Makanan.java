...
import com.example.verdian.sikecil.fragments.OneFragment;
import com.example.verdian.sikecil.fragments.TwoFragment;
import com.example.verdian.sikecil.fragments.ThridFragment;
...
public class Makanan extends AppCompatActivity
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new OneFragment(), "Umur 0-6 Bulan");
        adapter.addFragment(new TwoFragment(), "Umur 6-12 Bulan");
        adapter.addFragment(new ThridFragment(), "Umur 12-3 Tahun");
